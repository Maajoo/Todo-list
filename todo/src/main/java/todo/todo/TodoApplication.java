...
public class TodoApplication {
    ...
    public CommandLineRunner demo(UserRepository userRepository, TodoRepository todoRepository, TodoItemRepository todoItemRepository) {
        return (args) -> {
			...
			User user1 = new User("admin", "$2y$10$Ink5PBDfLR/yWQ2zdnqG2OtmtZ5Sx4zrilOg3lIrGWeNhNZy/kp0G", "admin.admin@email.com", "ADMIN");
            User user2 = new User("quest", "$2y$10$1gZJyL5/kyW3RCUHAXgUl.D9THZTACPsSui8feFxl58uYLYQm6xRi", "quest.quest@email.com", "QUEST");
